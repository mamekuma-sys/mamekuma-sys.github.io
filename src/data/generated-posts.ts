...
export const generatedPosts = [
  {
    ...
    "status": "published",
    "canonicalUrl": "https://mamekuma-sys.github.io/blog/ms-agent-does-not-properly-sanitize-commands-sent-to-its-shell-tool-allowing-for-rce",
    "keywords": [
      "analysis",
      "blog-agent",
      "rce",
    ...
    "toc": [
      ...
      {
        "level": 2,
        "title": "기술적으로 무엇이 핵심인가",
        "anchor": "기술적으로-무엇이-핵심인가"
      },
      {
        "level": 2,
        "title": "공격과 방어 관점에서의 함의",
        "anchor": "공격과-방어-관점에서의-함의"
      },
      {
        "level": 2,
        "title": "개인 학습 메모",
  ...
  },
  {
    ...
    "status": "published",
    "canonicalUrl": "https://mamekuma-sys.github.io/blog/crewai-contains-multiple-vulnerabilities-including-ssrf-rce-and-local-file-read",
    "keywords": [
      "ai",
      "analysis",
      "blog-agent",
